...
String apiKey = "CHAYJ2ITW69ZRSU5"; // Enter your Write API key from ThingSpeak
String get ="https://api.thingspeak.com/channels/1603605/feeds.json?results=2";
const char *ssid = "OPPO F17";     // replace with your wifi ssid and wpa2 key
const char *pass = "shahzaib310";
